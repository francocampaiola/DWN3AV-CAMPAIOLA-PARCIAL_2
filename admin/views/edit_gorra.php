...
<section>
    <div class="container">
        ...
        <form class="row g-3" action="actions/edit_gorra_acc.php?id=<?= $gorra->getId() ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="modelo" name="modelo" value="<?= $gorra->getModelo() ?>" required>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-12 mb-3 text-center">
                ...
                <div class="form-check d-flex gap-2 justify-content-center">
                    <?php foreach ($colores as $color) : ?>
                        <div>
                            <input name="color_id[]" id="color_id_<?= $color->getId() ?>" type="checkbox" value="<?= $color->getId() ?>" <?= in_array($color->getId(), $gorra->getColores()) ? 'checked' : '' ?>>
                            <?= $color->getNombre() ?>
                        </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control" id="fecha_lanzamiento" name="fecha_lanzamiento" value=<?= $gorra->getFechaLanzamiento() ?> required>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" min="0" class="form-control" id="stock" name="stock" value="<?= $gorra->getStock() ?>" required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="precio" class="form-label">Precio</label>
                <input type="number" step=0.01 class="form-control" id="precio" name="precio" value="<?= $gorra->getPrecio() ?>" required>
            </div>
            <div class="col-md-12 mb-3">
                <label for="descripcion" class="form-label">Descripción</label>
                <textarea class="form-control" id="descripcion" name="descripcion"><?= $gorra->getDescripcion() ?></textarea>
            </div>
